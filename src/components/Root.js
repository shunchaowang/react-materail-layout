...
class Root extends React.Component {
  constructor(props) {
    ...
    // config = initialConfig is not provided
    this.setCollapse = val => this.setState(({ collapsed }) => ({
      collapsed: typeof val === 'object' ? !collapsed : val
    }));

    this.setOpen = val => this.setState(({ open }) => ({
  ...
  render() {
    ...
    const value = {
      ...
      collapsedWidth: getScreenValue(collapsedWidth, width, initialState.collapsedWidth),
      collapsed: getScreenValue(collapsed, width, initialState.collapsed),
      ...
      headerPosition: getScreenValue(headerPosition, width, initialState.headerPosition),
...
const createScreenPropTypes = valPropTypes => PropTypes.shape({
  xs: valPropTypes,
  sm: valPropTypes,
  md: valPropTypes,
  lg: valPropTypes,
